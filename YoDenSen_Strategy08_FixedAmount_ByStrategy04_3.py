...
def backtest(start_date, end_date, hold_days, RSV_Ndays, RSV_Ratio, lstStockSorted, PickStockNumber, data, PathExcelFile, weight='average', benchmark=None, stop_loss=None, stop_profit=None):  
    ...
    '''    
    return equality, transections, sheet_name

# How many stock to by according to amount 
...
if __name__ == '__main__':  
    ...
    dfInitial = pd.DataFrame()
    AddDataToExcelSheet(PathExcelFile, 'All_ROE', dfInitial)          
    AddDataToExcelSheet(PathExcelFile, 'ALL_ROE_Sorted', dfInitial)
    ...
    for RSV_Ndays in range (50, 251, 50):
        for RSV_Ratio in range(0, 101, 10):
            ...
            for StockHold_Days in range (15, 121, 15):
                ...
                equality, transections, sheet_name = backtest(StartDate, EndDate, StockHold_Days, RSV_Ndays, RSV_Ratio, lstStockSorted, PickStockNumber, Data(), PathExcelFile)
