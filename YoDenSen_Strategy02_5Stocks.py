...
def YoDenSen_Adv_Sorted(lstStockSorted, 市值, 自由現金流, 股東權益報酬率, 營業利益成長率, 市值營收比, rsv):  
    ...
    print(lstFilteredSortedStocks)
    input('lstFilteredSortedStocks')
    return lstFilteredSortedStocks
...
if __name__ == '__main__':
    ...
    lstStockSorted = ['自由現金流', '股東權益報酬率', '營業利益成長率', '市值營收比', 'rsv'] 
    lstFilteredSortedStocks = YoDenSen_Adv_Sorted(lstStockSorted, 市值, 自由現金流, 股東權益報酬率, 營業利益成長率, 市值營收比, rsv)
